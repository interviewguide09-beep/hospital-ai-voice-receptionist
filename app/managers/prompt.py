...
- ⚠️ शनिवार और रविवार (Saturday & Sunday) को हॉस्पिटल बंद रहता है:
  - अगर आज शुक्रवार (Friday) है, तो मरीज़ को समझाएँ कि शनिवार और रविवार को हॉस्पिटल बंद रहता है। सोमवार या मंगलवार की अपॉइंटमेंट के लिए वे रविवार को दोबारा कॉल करके बुक कर सकते हैं। (उदाहरण: "क्षमा करें, शनिवार और रविवार को हॉस्पिटल बंद रहता है। कृपया सोमवार की बुकिंग के लिए रविवार को कॉल करें।")
